package com.example.artem.roadtovacation.net;
...
public class MarvelApi {
    ...
    public Observable<ComicDataWrapper> getMarvelComics(String ts, String apikey, String hash) {
        MarvelApiEndPoint request = retrofit.create(MarvelApiEndPoint.class);
        return request.getComics(ts, apikey, hash);
    }
    ...
    public interface MarvelApiEndPoint{
        ...
        @GET(COMICS)
        Observable<ComicDataWrapper> getComics(@Query("ts") String ts, @Query("apikey") String apikey, @Query("hash") String hash );
    }
}
